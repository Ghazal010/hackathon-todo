...
Function Signature
pythondef add_task(title: str, description: str = "") -> dict:
    """
...
Very Long Valid Title: Exactly 200 characters should work
Very Long Valid Description: Exactly 1000 characters should work
Special Characters: Title/description with emojis, unicode should work
Newlines in Description: Should be allowed
Leading/Trailing Whitespace: Should be trimmed from title
